...
export function append_row_to_table(table_id, row_id, row_class, cell_texts,cel_type_tag, cel_link){
  ...
  append_to_html_with_atterbutes("title_"+row_id,"a","",cell_texts[1],{"href":cel_link})
